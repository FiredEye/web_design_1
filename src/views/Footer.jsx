...
const Footer = () => {
  return (
    <div className="bg-[linear-gradient(133deg,_#566270_0%,_#283444_100%)]">
      <div className="max-w-[1490px] mx-auto px-10 pt-[60px] pb-[50px]">
                ...
                >
                  ...
                  <ul className="flex flex-col gap-4">
                    {item.links.map((link, i) => (
                      ...
                      >
                        <li className="font-medium text-sm md:text-base cursor-pointer text-center xl:text-start w-fit hover:bg-[linear-gradient(90deg,_#2AF598_0%,_#009EFD_100%)] hover:bg-clip-text hover:text-transparent" >
                          {link}
                        </li>
                      </div>
                    ))}
                ...
                >
                  ...
                  <ul className="flex flex-col gap-4">
                    {item.links.map((link, i) => (
                      ...
                      >
                        <li
                          className={`font-medium text-sm md:text-base ${index !==1 && "cursor-pointer hover:bg-[linear-gradient(90deg,_#2AF598_0%,_#009EFD_100%)] hover:bg-clip-text hover:text-transparent"} text-center xl:text-start w-fit`}
                        >
                          {link}
                        </li>
                      </div>
